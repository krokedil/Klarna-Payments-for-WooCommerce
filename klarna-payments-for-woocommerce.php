...
if ( ! class_exists( 'WC_Klarna_Payments' ) ) {
	...
	class WC_Klarna_Payments {
		...
		public function init_gateways() {
			...
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/includes/class-wc-klarna-payments-order-lines-order.php';
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/includes/class-wc-klarna-gdpr.php';
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/includes/class-wc-klarna-subscriptions.php';
